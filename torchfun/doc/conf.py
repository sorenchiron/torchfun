...
latex_documents = [
    (master_doc, 'torchfun.tex', 'torchfun Documentation',
     'chensiyu', 'manual'),
]
...
man_pages = [
    (master_doc, 'torchfun', 'torchfun Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'torchfun', 'torchfun Documentation',
     author, 'torchfun', 'One line description of project.',
     'Miscellaneous'),
]
